...
{
    public abstract class TestXiaWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static TestXiaWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(TestXiaWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<TestXiaDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<TestXiaDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<TestXiaDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<TestXiaDbContext, Task<T>> func)
        {
            T result;
