...
namespace TestXia.Migrations
{
    ...
    [Migration("20240102020006_AddNewColumn_20240102")]
    partial class AddNewColumn_20240102
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestXia.TestCreateTable.TestCreateTable", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("TestCreateTable");
                });

            modelBuilder.Entity("TestXia.TestCreateTable2.TestCreateTable2", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("TestXia.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("TestXia.Authorization.Users.User", null)
                        .WithMany("Claims")
